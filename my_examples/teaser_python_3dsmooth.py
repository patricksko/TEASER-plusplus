...
def execute_teaser_global_registration(source, target):
    ...
    solver_params.rotation_estimation_algorithm = (
        tpp.RotationEstimationAlgorithm.GNC_TLS
    )
    solver_params.rotation_gnc_factor = 1.4
    solver_params.rotation_max_iterations = 100
    solver_params.rotation_cost_threshold = 1e-12
    print("TEASER++ Parameters are:", solver_params)
    teaserpp_solver = tpp.RobustRegistrationSolver(solver_params)
...
if __name__ == "__main__":
    ...
    scene_path = os.path.abspath("../../examples/example_data/3dmatch_sample/")
    desc_path = os.path.abspath("../../examples/example_data/3dmatch_sample/")
    gt_path = os.path.abspath("../../examples/example_data/3dmatch_sample/gt.log")
    pair = (2, 36)
